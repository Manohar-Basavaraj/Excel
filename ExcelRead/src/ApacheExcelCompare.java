...
public class ApacheExcelCompare {
    ...
    public static void main(String[] args) throws Exception {
		 ...
		 * File(args[1]).exists())) {
		 * System.err.println("java -cp <classpath> "+ApacheExcelCompare.class.
		 * getCanonicalName()+" <TestData.xls/x> <TestData2.xls/x>"); System.exit(-1); }
		 */

        try (Workbook wb1 = WorkbookFactory.create(new File("C:\\Users\\manohar.b\\Desktop\\TestData1.xlsx"), null, true)) {
            try (Workbook wb2 = WorkbookFactory.create(new File("C:\\Users\\manohar.b\\Desktop\\TestData2.xlsx"), null, true)) {
                for (String d : ApacheExcelCompare.compare(wb1, wb2)) {
    ...
    public static List<String> compare(Workbook wb1, Workbook wb2) {
        ...
        ApacheExcelCompare excelComparator = new ApacheExcelCompare();
    ...
    private void compareDataInCell(Locator loc1, Locator loc2) {
		...
		/*
		 * isCellFillPatternMatches(loc1,loc2); isCellAlignmentMatches(loc1,loc2);
		 * isCellHiddenMatches(loc1,loc2); isCellLockedMatches(loc1,loc2);
		 * isCellFontFamilyMatches(loc1,loc2); isCellFontSizeMatches(loc1,loc2);
		 * isCellFontBoldMatches(loc1,loc2); isCellUnderLineMatches(loc1,loc2);
		 * isCellFontItalicsMatches(loc1,loc2); isCellBorderMatches(loc1,loc2,'t');
		 * isCellBorderMatches(loc1,loc2,'l'); isCellBorderMatches(loc1,loc2,'b');
		 * isCellBorderMatches(loc1,loc2,'r'); isCellFillBackGroundMatches(loc1,loc2);
		 */
    }
